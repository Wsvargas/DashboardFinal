...
from config          import BLACK, CARD, BORDER, RED, GREEN, AMBER, MUTED, BG, MODEL_FILE
from core.helpers    import md, fmt_num, extract_lote_codigo, _file_mtime, _limpiar_historial_para_modelo
